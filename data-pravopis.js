...
const TOPICS = [
  ...
  ───────────────────────────────────────────── */
  {
    ...
    cards: [
      ...
      {q:'b<em>_</em>strý chlapec (rychle myslí)', a:'bystrý', explain:'Vyjmenované slovo po B → tvrdé Y.'},
      {q:'b<em>_</em>linkový čaj', a:'bylinkový', explain:'Odvozeno od slova "bylina" — vyjmenované slovo po B.'},
      {q:'pob<em>_</em>tovat někde', a:'pobývat', explain:'Příbuzné se slovem "být" — vyjmenované slovo po B.'},
      {q:'B<em>_</em>l doma. (minulý čas slovesa "být")', a:'Byl', explain:'Sloveso "být" → vyjmenované slovo po B.'},
      {q:'B<em>_</em>l žáka přes ruku. (mlátil)', a:'Bil', explain:'"Bít" (mlátit) NENÍ vyjmenované slovo — měkké I.'},
      {q:'náb<em>_</em>tek v obýváku', a:'nábytek', explain:'Vyjmenované slovo po B.'},
      ...
      {q:'sl<em>_</em>šet hudbu', a:'slyšet', explain:'Vyjmenované slovo po L.'},
      {q:'starý ml<em>_</em>n', a:'mlýn', explain:'Vyjmenované slovo po L s dlouhým ý.'},
      {q:'l<em>_</em>že na sníh', a:'lyže', explain:'Vyjmenované slovo po L.'},
      {q:'pol<em>_</em>kat sousto', a:'polykat', explain:'Vyjmenované slovo po L.'},
      {q:'odl<em>_</em>vat kovy (v hutě)', a:'odlévat', explain:'NENÍ vyjmenované slovo — od "lít" → měkké I.'},
      {q:'pl<em>_</em>tvat penězi', a:'plýtvat', explain:'Vyjmenované slovo po L.'},
      {q:'l<em>_</em>tko bolí (část nohy)', a:'lýtko', explain:'Vyjmenované slovo po L.'},
      ...
      {q:'M<em>_</em> jdeme domů. (zájmeno)', a:'My', explain:'Zájmeno "my" → vyjmenované slovo po M.'},
      {q:'M<em>_</em>t okna', a:'Mýt', explain:'"Mýt" (umývat) je vyjmenované slovo po M.'},
      {q:'M<em>_</em>t rád zvířata', a:'Mít', explain:'"Mít" (vlastnit) NENÍ vyjmenované slovo — měkké I.'},
      {q:'spadla mu m<em>_</em>š', a:'myš', explain:'Vyjmenované slovo po M.'},
      {q:'m<em>_</em>slet na úkol', a:'myslet', explain:'Příbuzné se slovem "myslit" — vyjmenované slovo po M.'},
      {q:'mám zam<em>_</em>káno (nemůžu se dostat ven)', a:'zamykáno', explain:'Příbuzné se slovem "zamykat" — vyjmenované slovo po M.'},
      {q:'m<em>_</em>lit se (chybovat)', a:'mýlit', explain:'Vyjmenované slovo po M.'},
      ...
      {q:'p<em>_</em>cha předchází pád', a:'pýcha', explain:'Vyjmenované slovo po P.'},
      {q:'p<em>_</em>tel brambor', a:'pytel', explain:'Vyjmenované slovo po P.'},
      {q:'netop<em>_</em>r (létající savec)', a:'netopýr', explain:'Vyjmenované slovo po P.'},
      {q:'P<em>_</em>l z květu obtěžuje alergiky.', a:'Pyl', explain:'"Pyl" (květový) je vyjmenované slovo po P.'},
      {q:'P<em>_</em>l limonádu. (sloveso pít)', a:'Pil', explain:'"Pít" NENÍ vyjmenované slovo — měkké I.'},
      {q:'kop<em>_</em>to koně', a:'kopyto', explain:'Vyjmenované slovo po P.'},
      ...
      {q:'mladý s<em>_</em>n', a:'syn', explain:'Vyjmenované slovo po S.'},
      {q:'s<em>_</em>chravé počasí', a:'sychravé', explain:'Vyjmenované slovo po S.'},
      {q:'s<em>_</em>kora modřinka', a:'sýkora', explain:'Vyjmenované slovo po S.'},
      {q:'s<em>_</em>rové maso', a:'syrové', explain:'Vyjmenované slovo po S.'},
      {q:'s<em>_</em>rup proti kašli', a:'sirup', explain:'NENÍ vyjmenované slovo (přejaté z arabštiny) — měkké I.'},
      ...
      {q:'V<em>_</em>soká věž', a:'Vysoká', explain:'Vyjmenované slovo po V.'},
      {q:'v<em>_</em>dra v řece', a:'vydra', explain:'Vyjmenované slovo po V.'},
      {q:'žv<em>_</em>kat žvýkačku', a:'žvýkat', explain:'Vyjmenované slovo po V.'},
      {q:'V<em>_</em>šehrad (pražská čtvrť)', a:'Vyšehrad', explain:'Vlastní jméno z vyjmenovaných slov po V.'},
      {q:'zv<em>_</em>kat na novou školu', a:'zvykat', explain:'Vyjmenované slovo po V.'},

      // === PO Z ===
      {q:'Vyjmenovaná slova po Z', a:'brzy, jazyk, nazývat (se), Ruzyně', explain:'Velmi krátká řada — jen 4 hlavní slova.'},
      {q:'br<em>_</em> ráno', a:'brzy', explain:'Vyjmenované slovo po Z.'},
      {q:'mateřský jaz<em>_</em>k', a:'jazyk', explain:'Vyjmenované slovo po Z.'},
      {q:'naz<em>_</em>vat věci pravými jmény', a:'nazývat', explain:'Vyjmenované slovo po Z.'},
  ...
  ───────────────────────────────────────────── */
  {
    ...
    cards: [
      ...
      {q:'Křest<em>_</em>nské svátky', a:'křesťanské', explain:'Přídavné jméno odvozené — malé. Velké by bylo jen ve vlastním jméně instituce.'},
      {q:'pan<em>_</em> doktor Novák', a:'pan', explain:'Zdvořilostní oslovení — malé.'},
      {q:'jaro<em>_</em>í prázdniny', a:'jarní', explain:'Přídavné jméno — malé. Není to vlastní jméno svátku.'},
      {q:'V Praze stojí <em>_</em>árodní divadlo.', a:'Národní', explain:'Vlastní jméno instituce — velké.'},
      {q:'V neděli <em>_</em>elikonoce končí.', a:'Velikonoce', explain:'Svátek — velké V.'},
      {q:'Sluníčko vyšlo nad <em>_</em>nězí horami.', a:'Sněžnými', explain:'Pokud je toto vlastní jméno hor — velké S. Jinak (obecné) malé.'},
      {q:'Studuje na <em>_</em>arlově univerzitě.', a:'Karlově', explain:'Část vlastního jména instituce.'},
      {q:'Přijela do <em>_</em>panělska.', a:'Španělska', explain:'Stát — velké.'},
      {q:'Mluví <em>_</em>panělsky.', a:'španělsky', explain:'Příslovce odvozené — malé.'},
      {q:'Připadá na <em>_</em>tědrý den.', a:'Štědrý', explain:'Svátek — velké.'},
      {q:'Spojené státy <em>_</em>merické', a:'americké', explain:'POZOR — u "Spojené státy americké" se "americké" píše s MALÝM (přívlastek, ne vlastní jméno).'},
      {q:'<em>_</em>vatý Václav', a:'Svatý', explain:'V češtině se "Svatý" píše s velkým ve významu titulu před jménem světce.'},
      {q:'Jdeme do kina v <em>_</em>terý.', a:'úterý', explain:'Den v týdnu — malé.'},
      {q:'Bydlí v <em>_</em>echách.', a:'Čechách', explain:'Geografický celek — velké.'},
      {q:'Mluví <em>_</em>esky.', a:'česky', explain:'Příslovce — malé.'}
    ],
    quiz: [
  ...
  ───────────────────────────────────────────── */
  {
    ...
    cards: [
      ...
      {q:'Dejte tu věc <em>_</em>.', a:'mně', explain:'Dej tobě? → MNĚ. (3. pád)'},
  ...
  ───────────────────────────────────────────── */
  {
    ...
    cards: [
      ...
      {q:'<em>_</em>lézt po žebříku dolů', a:'Slézt', explain:'Pohyb DOLŮ → S-.'},
      {q:'<em>_</em>lézt na vrchol hory', a:'Vylézt', explain:'POZOR! Tady NENÍ ani S- ani Z-, je to VY- (vystoupat). VZLÉZT (méně časté) by také šlo.'},
      {q:'<em>_</em>letět z hnízda nahoru', a:'Vzletět', explain:'Pohyb NAHORU → VZ-.'},
      {q:'<em>_</em>letět na zem', a:'Sletět', explain:'Pohyb DOLŮ → S-.'},
      {q:'<em>_</em>bírat všechny věci na hromadu', a:'Sbírat', explain:'DOHROMADY → S-.'},
      {q:'<em>_</em>bourat starý dům', a:'Zbourat', explain:'ZMĚNA STAVU (z domu se stane ruina) → Z-.'},
      {q:'<em>_</em>kazit oslavu', a:'Zkazit', explain:'ZMĚNA STAVU (oslava byla pokažená) → Z-.'},
      {q:'<em>_</em>tříhnout vlasy', a:'Stříhnout', explain:'PRYČ Z POVRCHU → S-. POZOR: psaní -ž- ve "stříhnout" je správné (zní jako š, ale pochází z "stříž").'},
      {q:'<em>_</em>brat kufr a odejít', a:'Sbalit', explain:'DOHROMADY (sbalit věci) → S-.'},
      {q:'<em>_</em>chodit dolů ze schodů', a:'Schodit / sejít', explain:'Pohyb DOLŮ → S-. (Sejít ze schodů.)'},
      {q:'<em>_</em>jít z cesty (zabloudit)', a:'Sejít / Zejít', explain:'POZOR! "Sejít z cesty" = uhnout z cesty (S-, dolů, pryč). Obojí se ale píše s S- ve standardním významu.'},
      {q:'<em>_</em>zelenat', a:'Zezelenat', explain:'ZMĚNA STAVU (stal se zeleným) → Z-.'},
      {q:'<em>_</em>chudnout', a:'Zchudnout', explain:'ZMĚNA STAVU → Z-.'},
      {q:'<em>_</em>blednout (zbledli leknutím)', a:'Zblednout', explain:'ZMĚNA STAVU → Z-.'},
      {q:'<em>_</em>tahat se s něčím (boj)', a:'Stahat / pohádat', explain:'POZOR! "Stahat se" = svléknout. Pohádka × pohádat se. Pro pohádat se je obvykle pohádat.'},
      {q:'<em>_</em>tělit se (hubený)', a:'Ztělit (zhubnout)', explain:'ZMĚNA STAVU → Z-. POZOR: zde "ztělit" je archaické. Běžně řekneme "zhubnout".'},
      {q:'<em>_</em>plánovat výlet', a:'Naplánovat', explain:'TRIK! Toto NENÍ S/Z předpona, je to NA-.'}
    ],
    quiz: [
  ...
  ───────────────────────────────────────────── */
  {
    ...
    cards: [
      ...
      {q:'"Petr<em>_</em> kamarádi přišli." (mužský životný)', a:'Petrovi', explain:'Mužský životný v 1. pádu množ. čísla → -OVI.'},
      {q:'"Petr<em>_</em> ruce jsou špinavé." (neživotné, ženský rod plurál - ruce)', a:'Petrovy', explain:'POZOR — "ruce" jsou rod ženský, koncovka by měla být -ovy.'},
      {q:'"Petr<em>_</em> psi štěkají." (mužský životný)', a:'Petrovi', explain:'Psi = mužský životný → -OVI.'},
      {q:'"Petr<em>_</em> boty jsou nové." (rod ženský — boty)', a:'Petrovy', explain:'Boty = rod ženský pomnožný → -OVY (jako rod ženský).'},
      {q:'"Petr<em>_</em> auto nejede." (rod střední)', a:'Petrovo', explain:'Auto = rod střední → -OVO.'},
      {q:'"Daroval Petr<em>_</em> kamarádovi knihu." (3. pád)', a:'Petrovu / Petrově', explain:'POZOR — koncovka -OVU/-OVĚ ve 3. pádu. Tato otázka je trošku chyták.'},
      {q:'"Strýc<em>_</em> dům" (přivlastňovací — komu patří dům)', a:'Strýcův', explain:'V 1. pádu se píše -ŮV (krátký).'},
      {q:'"Strýc<em>_</em> děti přijely." (1. pád, mužský životný plurál)', a:'Strýcovi', explain:'Děti = obojetné. Pokud myslíme děti = mužský životný (chlapci), -OVI. Pokud rod ženský/smíšený, -OVY.'},
      {q:'"Karl<em>_</em> Hrad — Karlův hrad?" (správné psaní vlastního jména hradu)', a:'Karlštejn', explain:'Karlštejn je VLASTNÍ JMÉNO HRADU — píšeme jako jedno slovo.'},
      {q:'"otc<em>_</em> přátelé" (1. pád, mužský životný)', a:'otcovi', explain:'Otcovi přátelé (přijeli) → mužský životný → -OVI.'},
      {q:'"otc<em>_</em> peníze" (rod ženský/neživotný)', a:'otcovy', explain:'Peníze = rod mužský neživotný v plurálu → -OVY.'},
      {q:'"otc<em>_</em> auto" (rod střední)', a:'otcovo', explain:'Rod střední → -OVO.'},
      {q:'"sousedov<em>_</em> psi" (1. pád životný)', a:'sousedovi', explain:'Psi = životní → -OVI.'},
      {q:'"sousedov<em>_</em> stromy" (1. pád neživotný)', a:'sousedovy', explain:'Stromy = mužský neživotný → -OVY.'},
      {q:'"sousedov<em>_</em> zahrady" (1. pád ženský)', a:'sousedovy', explain:'Zahrady = ženský rod → -OVY.'},
      {q:'"sousedov<em>_</em> kotě" (rod střední)', a:'sousedovo', explain:'Kotě = střední rod → -OVO.'},
      {q:'"přijde s Petrov<em>_</em> kamarádem" (7. pád)', a:'Petrovým', explain:'7. pád → -OVÝM.'}
    ],
    quiz: [
